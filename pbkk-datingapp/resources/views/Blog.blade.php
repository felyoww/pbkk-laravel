...
<div class="min-h-full">
              ...
              <div class="relative ml-3">
                <div>
                  <button type="button"  @click="isOpen = !isOpen" class="relative flex max-w-xs items-center rounded-full bg-gray-800 text-sm focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-800" id="user-menu-button" aria-expanded="false" aria-haspopup="true">
                    ...
                    <img class="h-8 w-8 rounded-full" src="https://pbs.twimg.com/media/FnKRBZraUAEZWpt.jpg" alt="">
                  </button>
                </div>
      ...
      <div x-show="isOpen" class="md:hidden" id="mobile-menu">
        ...
        <div class="border-t border-gray-700 pb-3 pt-4">
          <div class="flex items-center px-5">
            <div class="flex-shrink-0">
              <img class="h-10 w-10 rounded-full" src="https://pbs.twimg.com/media/FnKRBZraUAEZWpt.jpg" alt="">
            </div>
            <div class="ml-3">
              <div class="text-base font-medium leading-none text-white">Fellyla</div>
              <div class="text-sm font-medium leading-none text-gray-400">fellyla@example.com</div>
            </div>
    ...
    <header class="bg-white shadow">
      <div class="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
        <h1 class="text-3xl font-bold tracking-tight text-gray-900">My Blog! <i class="fas fa-star"></i></h1>
      </div>
    </header>
    <main>
      <div class="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
        <!-- Your content -->
        <article>
          <h1><strong>What does the fox say?</strong> </h1>
            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. 
              Velit commodi repellendus voluptatum iure harum assumenda!
               Quis ducimus quaerat repellendus amet, eligendi, recusandae minima eius ea unde quia animi rerum consectetur.</p>
        </article>

        <article>
          <h1><b>Shinzou wo Sasageyo!</b></h1>
          <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. 
            Architecto soluta porro tenetur? Vel tenetur nostrum repellat nesciunt at ex, veniam est tempore. 
            Aspernatur deleniti minima, quas dolorem vitae cum official.
          </p>
        </article>
      </div>
    </main>
